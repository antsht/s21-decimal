# Team project in School-21

## Implementation of the decimal.h library functions

The functions of the decimal.h library described below are implemented:
- The library developed in C language of C11 standard using gcc compiler.
- Made it as a static library named *s21_decimal* (with the s21_decimal.h header file).
