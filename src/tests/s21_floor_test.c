...
START_TEST(s21_floor_42949_67295_to_42949) {
  ...
  ck_assert(res == OK && dec_res.bits[0] == 42949 && dec_res.bits[1] == 0 &&
            dec_res.bits[2] == 0 && dec_res.bits[3] == 0);
}
END_TEST
...
START_TEST(s21_floor_minus_1234567_1234567_to_minus_1234568) {
  ...
  ck_assert(res == OK && dec_res.bits[0] == 1234568 && dec_res.bits[1] == 0 &&
            dec_res.bits[2] == 0 && dec_res.bits[3] == 2147483648);
}
END_TEST
...
START_TEST(s21_floor_1234567890_1234567890_to_1234567890) {
  ...
  ck_assert(res == OK && dec_res.bits[0] == 1234567890 &&
...
START_TEST(s21_floor_minus_1234567890_1234567890_to_minus_1234567890) {
  ...
  ck_assert(res == OK && dec_res.bits[0] == 1234567891 &&
            dec_res.bits[1] == 0 && dec_res.bits[2] == 0 &&
...
START_TEST(s21_floor_big00_5_to_big00) {
  ...
  ck_assert(res == OK && dec_res.bits[0] == 0x8888888 &&
            dec_res.bits[1] == 0x80000000 && dec_res.bits[2] == 0x8888888 &&
            dec_res.bits[3] == 0x0);
}
END_TEST
...
START_TEST(s21_floor_big93_5_to_big93) {
  ...
  ck_assert(res == OK && dec_res.bits[0] == 3047500985 &&
...
Suite *s21_floor_suite(void) {
  Suite *s;
  s = suite_create("s21_floor() tests");
  TCase *tc;
  tc = tcase_create("floor");
  tcase_add_test(tc, s21_floor_to_1);
  tcase_add_test(tc, s21_floor_1_8_to_1);
  tcase_add_test(tc, s21_floor_to_minus_2);
  tcase_add_test(tc, s21_floor_zero_to_zero);
  tcase_add_test(tc, s21_floor_pos_to_zero);
  tcase_add_test(tc, s21_floor_neg_to_1);
  tcase_add_test(tc, s21_floor_0_max_to_7);
  tcase_add_test(tc, s21_floor_max_to_max);
  tcase_add_test(tc, s21_floor_099999999999999999999_to_0);
  tcase_add_test(tc, s21_floor_minus_099999999999999999999_to_minus_1);
  tcase_add_test(tc, s21_floor_09_to_0);
  tcase_add_test(tc, s21_floor_minus_09_to_minus_1);
  tcase_add_test(tc, s21_floor_minus_049_to_minus_1);
  tcase_add_test(tc, s21_floor_minus_05_to_minus_1);
  tcase_add_test(tc, s21_floor_minus_051_to_minus_1);
  tcase_add_test(tc, s21_floor_049_to_0);
  tcase_add_test(tc, s21_floor_050_to_0);
  tcase_add_test(tc, s21_floor_051_to_0);
  tcase_add_test(tc, s21_floor_1_low_to_1);
  tcase_add_test(tc, s21_floor_42949_67295_to_42949);
  tcase_add_test(tc, s21_floor_minus_42949_67295_to_minus_42950);
  tcase_add_test(tc, s21_floor_minus_1234567890_1234567890_to_minus_1234567890);
  tcase_add_test(tc, s21_floor_1234567890_1234567890_to_1234567890);
  tcase_add_test(tc, s21_floor_minus_1234567_1234567_to_minus_1234568);
  tcase_add_test(tc, s21_floor_1234567_1234567_to_1234567);
  tcase_add_test(tc, s21_floor_1235_5_to_1235);
  tcase_add_test(tc, s21_floor_1234_5_to_1234);
  tcase_add_test(tc, s21_floor_wrong_dec);
  tcase_add_test(tc, s21_floor_null_dec);
  tcase_add_test(tc, s21_floor_big00_5_to_big00);
  tcase_add_test(tc, s21_floor_big93_5_to_big93);

  suite_add_tcase(s, tc);
  return s;
}

int s21_floor_test(void) {
  Suite *s = s21_floor_suite();
