...
START_TEST(s21_round_to_1) {
  ...
  s21_set_scale_of_decimal(&dec, 4);
  s21_decimal dec_res;
  // 1.45 -> 1
...
START_TEST(s21_round_to_2) {
  ...
  s21_set_scale_of_decimal(&dec, 1);
  s21_decimal dec_res;
  // 1.8 -> 2
  int res = s21_round(dec, &dec_res);

  ck_assert(res == OK && dec_res.bits[0] == 2 && dec_res.bits[1] == 0 &&
            dec_res.bits[2] == 0 && dec_res.bits[3] == 0);
}
END_TEST
...
START_TEST(s21_round_to_minus_2) {
  ...
  ck_assert(res == OK && dec_res.bits[0] == 2 && dec_res.bits[1] == 0 &&
            dec_res.bits[2] == 0 && dec_res.bits[3] == 0x80000000);
}
END_TEST
...
START_TEST(s21_round_0_max_to_8) {
  ...
  ck_assert(res == OK && dec_res.bits[0] == 8 && dec_res.bits[1] == 0 &&
            dec_res.bits[2] == 0 && dec_res.bits[3] == 0);
}
END_TEST
...
START_TEST(s21_round_max_to_max) {
  ...
  ck_assert(res == OK && dec_res.bits[0] == 0xffffffff &&
            dec_res.bits[1] == 0xffffffff && dec_res.bits[2] == 0xffffffff &&
            dec_res.bits[3] == 0);
}
END_TEST
...
START_TEST(s21_round_42949_67295_to_42950) {
  ...
  ck_assert(res == OK && dec_res.bits[0] == 0xA7C6 && dec_res.bits[1] == 0 &&
            dec_res.bits[2] == 0 && dec_res.bits[3] == 0);
}
END_TEST
...
START_TEST(s21_round_1234567_1234567_to_1234567) {
  ...
  ck_assert(res == OK && dec_res.bits[0] == 0x12D687 && dec_res.bits[1] == 0 &&
...
START_TEST(s21_round_1234567890_1234567890_to_1234567890) {
  ...
  ck_assert(res == OK && dec_res.bits[0] == 0x499602D2 &&
...
START_TEST(s21_round_1234_5_to_1234) {
  ...
  ck_assert(res == OK && dec_res.bits[0] == 0x4d2 && dec_res.bits[1] == 0 &&
            dec_res.bits[2] == 0 && dec_res.bits[3] == 0x0);
}
END_TEST
...
START_TEST(s21_round_1234_500000001_to_1235) {
  ...
  s21_set_scale_of_decimal(&dec, 9);
  s21_decimal dec_res;
  // 1234.500000001 -> 1235
  int res = s21_round(dec, &dec_res);

  ck_assert(res == OK && dec_res.bits[0] == 1235 && dec_res.bits[1] == 0 &&
            dec_res.bits[2] == 0 && dec_res.bits[3] == 0);
}
END_TEST
...
START_TEST(s21_round_1235_5_to_1236) {
  ...
  ck_assert(res == OK && dec_res.bits[0] == 0x4d4 && dec_res.bits[1] == 0 &&
            dec_res.bits[2] == 0 && dec_res.bits[3] == 0x0);
}
END_TEST
...
START_TEST(s21_round_big00_5_to_big00) {
  ...
  ck_assert(res == OK && dec_res.bits[0] == 143165576 &&
...
START_TEST(s21_round_big93_5_to_big94) {
  ...
  ck_assert(res == OK && dec_res.bits[0] == 3047500986 &&
...
Suite *s21_round_suite(void) {
  Suite *s;
  s = suite_create("s21_round() tests");
  TCase *tc;
  tc = tcase_create("round");
  tcase_add_test(tc, s21_round_to_1);
  tcase_add_test(tc, s21_round_to_2);
  tcase_add_test(tc, s21_round_to_minus_2);
  tcase_add_test(tc, s21_round_zero_to_zero);
  tcase_add_test(tc, s21_round_pos_to_zero);
  tcase_add_test(tc, s21_round_neg_to_zero);
  tcase_add_test(tc, s21_round_0_max_to_8);
  tcase_add_test(tc, s21_round_max_to_max);
  tcase_add_test(tc, s21_round_099999999999999999999_to_1);
  tcase_add_test(tc, s21_round_minus_099999999999999999999_to_minus_1);
  tcase_add_test(tc, s21_round_09_to_1);
  tcase_add_test(tc, s21_round_minus_09_to_minus_1);
  tcase_add_test(tc, s21_round_minus_049_to_minus_0);
  tcase_add_test(tc, s21_round_minus_05_to_minus_0);
  tcase_add_test(tc, s21_round_minus_1_5_to_minus_2);
  tcase_add_test(tc, s21_round_minus_051_to_minus_1);
  tcase_add_test(tc, s21_round_049_to_0);
  tcase_add_test(tc, s21_round_050_to_0);
  tcase_add_test(tc, s21_round_051_to_1);
  tcase_add_test(tc, s21_round_1_low_to_1);
  tcase_add_test(tc, s21_round_42949_67295_to_42950);
  tcase_add_test(tc, s21_round_minus_42949_67295_to_minus_42950);
  tcase_add_test(tc, s21_round_minus_1234567890_1234567890_to_minus_1234567890);
  tcase_add_test(tc, s21_round_1234567890_1234567890_to_1234567890);
  tcase_add_test(tc, s21_round_minus_1234567_1234567_to_minus_1234567);
  tcase_add_test(tc, s21_round_1234567_1234567_to_1234567);
  tcase_add_test(tc, s21_round_1235_5_to_1236);
  tcase_add_test(tc, s21_round_1234_5_to_1234);
  tcase_add_test(tc, s21_round_1234_500000001_to_1235);
  tcase_add_test(tc, s21_round_wrong_dec);
  tcase_add_test(tc, s21_round_null_dec);
  tcase_add_test(tc, s21_round_big00_5_to_big00);
  tcase_add_test(tc, s21_round_big93_5_to_big94);
  tcase_add_test(tc, s21_round_0_50000000000000001);
  tcase_add_test(tc, s21_round_0_50000000000000000);
  tcase_add_test(tc, s21_round_0_49999999999999999);
  tcase_add_test(tc, s21_round_1_49999999999999999);
  tcase_add_test(tc, s21_round_1_50000000000000000);
  tcase_add_test(tc, s21_round_1_50000000000000001);

  suite_add_tcase(s, tc);
  return s;
}

int s21_round_test(void) {
  Suite *s = s21_round_suite();
